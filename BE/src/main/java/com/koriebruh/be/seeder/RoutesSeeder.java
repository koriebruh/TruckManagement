...
//         Cek apakah route sudah ada sebelum menjalankan seeder
    ...
    public void seederRoute() {
        List<RouteRequest> routeRequests = List.of(
                ...
                /* MUATAN PUPUK*/
                new RouteRequest(getIdCityByName("Batang"), getIdCityByName("Dieng"), "-", "PUPUK", 510_000.0, true),
                new RouteRequest(getIdCityByName("Pekalongan"), getIdCityByName("Dieng"), "-", "PUPUK", 510_000.0, true),
                new RouteRequest(getIdCityByName("Boja"), getIdCityByName("Dieng"), "-", "PUPUK", 560_000.0, true),
                new RouteRequest(getIdCityByName("Pemalang"), getIdCityByName("Dieng"), "-", "PUPUK", 560_000.0, true),
                new RouteRequest(getIdCityByName("Tegal"), getIdCityByName("Dieng"), "-", "PUPUK", 610_000.0, true),
                new RouteRequest(getIdCityByName("Brebes"), getIdCityByName("Dieng"), "-", "PUPUK", 610_000.0, true),
                new RouteRequest(getIdCityByName("Banjarnegara"), getIdCityByName("Dieng"), "-", "PUPUK", 510_000.0, true),
                new RouteRequest(getIdCityByName("Purbalingga"), getIdCityByName("Dieng"), "-", "PUPUK", 510_000.0, true),
                new RouteRequest(getIdCityByName("Banyumas"), getIdCityByName("Dieng"), "-", "PUPUK", 560_000.0, true),
                new RouteRequest(getIdCityByName("Gunung Kidul"), getIdCityByName("Dieng"), "-", "PUPUK", 610_000.0, true),
                new RouteRequest(getIdCityByName("Sragen"), getIdCityByName("Dieng"), "-", "PUPUK", 610_000.0, true),
                new RouteRequest(getIdCityByName("Wonogiri"), getIdCityByName("Dieng"), "-", "PUPUK", 710_000.0, true),
                new RouteRequest(getIdCityByName("Kudus"), getIdCityByName("Dieng"), "-", "PUPUK", 710_000.0, true),
                new RouteRequest(getIdCityByName("Pati"), getIdCityByName("Dieng"), "-", "PUPUK", 710_000.0, true),
                new RouteRequest(getIdCityByName("Jepara"), getIdCityByName("Dieng"), "-", "PUPUK", 710_000.0, true),
                new RouteRequest(getIdCityByName("Rembang"), getIdCityByName("Dieng"), "-", "PUPUK", 810_000.0, true),

                new RouteRequest(getIdCityByName("Pekalongan"), getIdCityByName("Jakarta"), "-", "PUPUK", 810_000.0, true),

//                new RouteRequest(getIdCityByName("Semua"), getIdCityByName("Pekalongan"), "PP", 550_000.0, true),

                new RouteRequest(getIdCityByName("Kutosari/Luwung"), getIdCityByName("Pekalongan"), "-", "PASIR", 410_000.0, true),
                new RouteRequest(getIdCityByName("Kutosari/Ambon"), getIdCityByName("Pekalongan"), "-", "PASIR", 360_000.0, true),
                new RouteRequest(getIdCityByName("Wonosobo Tambang"), getIdCityByName("Pekalongan"), "-", "PASIR", 560_000.0, true),
                new RouteRequest(getIdCityByName("Wonosobo Dipo"), getIdCityByName("Pekalongan"), "-", "PASIR", 510_000.0, true),
                new RouteRequest(getIdCityByName("Muntilan Tambang"), getIdCityByName("Pekalongan"), "-", "PASIR", 635_000.0, true),
                new RouteRequest(getIdCityByName("Muntilan Dipo"), getIdCityByName("Pekalongan"), "-", "PASIR", 560_000.0, true),
                new RouteRequest(getIdCityByName("Pekalongan"), getIdCityByName("Denpasar, Bali"), "-", "PASIR", 1_810_000.0, true),
                new RouteRequest(getIdCityByName("Pekalongan"), getIdCityByName("Mataram, NTB"), "-", "PASIR", 2_510_000.0, true),

                new RouteRequest(getIdCityByName("Dieng"), getIdCityByName("Mataram, NTB"), "-", "PASIR", 2_610_000.0, true)
    ...
    public void seederTransit() {
        List<TransitPointRequest> transitPoint = List.of(
                ...
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 250_000.0, true),
                new TransitPointRequest(getIdCityByName("Serang"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 350_000.0, true),
                new TransitPointRequest(getIdCityByName("Menes"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Ujung Kulon"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Kendal"), 30L, "PUPUK", 350_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Semarang"), 30L, "PUPUK", 350_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Demak"), 30L, "PUPUK", 400_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Kudus"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Pati"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Temanggung"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Solo"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Jakarta"), getIdCityByName("Jogja"), 30L, "PUPUK", 450_000.0, true),

                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Surabaya"), 30L, "PUPUK", 810_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 250_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Tegal"), 30L, "PUPUK", 350_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Brebes"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Purwokerto"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Purbalingga"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Dieng"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Surabaya"), getIdCityByName("Cirebon"), 30L, "PUPUK", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pasuruan"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 350_000.0, true),
                new TransitPointRequest(getIdCityByName("Malang"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 450_000.0, true),
                new TransitPointRequest(getIdCityByName("Bangkalan"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 400_000.0, true),
                new TransitPointRequest(getIdCityByName("Sumenep"), getIdCityByName("Pekalongan"), 30L, "PUPUK", 550_000.0, true),

                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Pati"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Solo"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Magelang"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Jogja"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Bantul"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Purbalingga"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Purwokerto"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Banyumas"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Kebumen"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Pekalongan"), 30L, "PAKAN", 550_000.0, true),
                new TransitPointRequest(getIdCityByName("Pekalongan"), getIdCityByName("Pekalongan"), 30L, "PAKAN", 550_000.0, true),

                new TransitPointRequest(getIdCityByName("Pielen"), getIdCityByName("Pekalongan"), 30L, "PASIR", 360_000.0, true),
                new TransitPointRequest(getIdCityByName("Denpasar, Bali"), getIdCityByName("Pekalongan"), 30L, "PASIR", 500_000.0, true),
                new TransitPointRequest(getIdCityByName("Mataram, NTB"), getIdCityByName("Pekalongan"), 30L, "PASIR", 650_000.0, true),
                new TransitPointRequest(getIdCityByName("Bima, NTB"), getIdCityByName("Pekalongan"), 30L, "PASIR", 950_000.0, true),
                new TransitPointRequest(getIdCityByName("Mataram, NTB"), getIdCityByName("Dieng"), 30L, "PASIR", 800_000.0, true),
                new TransitPointRequest(getIdCityByName("Bima, NTB"), getIdCityByName("Dieng"), 30L, "PASIR", 1_200_000.0, true)
        );
